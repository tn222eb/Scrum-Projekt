<%@ Page Title="Alla videoklipp" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Video.aspx.cs" Inherits="Tommy.Pages.Shared.Video" %>

<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    
    <h1>Alla videoklipp</h1>
    <br />
    <br />
    <br />
        ...
        <ItemTemplate>
                ...
                <asp:Label ID="Window" runat="server" Visible="false">
                   <div class="popupWindow">
                       <div class="fb-comments" data-href="http://mediaswag-001-site1.smarterasp.net/Videos/<%# Item.videoname %>" data-numposts="2" data-colorscheme="light" data-width="345px"></div>
                       </div>
                </asp:Label>
