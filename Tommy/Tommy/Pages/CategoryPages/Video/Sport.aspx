<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sport.aspx.cs" Inherits="Tommy.Pages.CategoryPages.Video.Sport" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br /><br />
      ...
      <asp:ListView ID="VideoListView" runat="server"
                ...
                <ItemTemplate>
   <a class="player" style="height: 350px; width: 350px;" href='<%#"../../../Videos/" + Item.videoname %>'>
        </a>
